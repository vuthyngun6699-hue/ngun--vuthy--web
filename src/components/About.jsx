      ...
      <div className="container" data-aos="fade-up" data-aos-delay="100">
        <div className="row gy-4 justify-content-center">
          ...
          <div className="col-lg-8 content">
            <h2>Wb Designer &amp; Web Developer.</h2>
            ...
            <div className="row">
              <div className="col-lg-6">
                <ul>
                  <li><i className="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>4 october 2007</span></li>
                  <li><i className="bi bi-chevron-right"></i> <strong>Website:</strong> <span>www.example.com</span></li>
                  <li><i className="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>078566952</span></li>
              ...
              <div className="col-lg-6">
                <ul>
                  ...
                  <li><i className="bi bi-chevron-right"></i> <strong>Email:</strong> <span>vuthyngun6699@gmail.com</span></li>
